...
{
    public record Command(Guid Id, string Name, DateTime DispatchDate, DateTime? DeliveryDate, Guid? CourierId, Guid CustomerId) : IValidatableRequest<Result<Response>>;
